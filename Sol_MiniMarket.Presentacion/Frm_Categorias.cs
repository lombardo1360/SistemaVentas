    ...
    public partial class Frm_Categorias : Form
    {
        ...
        private void Selecciona_item()
        {
            ...
            else
            {
                ...
                Txt_descripcion_ca.Text = Convert.ToString(Dgv_principal.CurrentRow.Cells["descripcio_ca"].Value);
            }
        }
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            else //Se procedera a registrar la informacion
            {
                E_Categorias oCa = new E_Categorias();
                string Rpta = "";
                oCa.Codigo_ca = this.Codigo_ca;
                oCa.Descrpcion_ca = Txt_descripcion_ca.Text.Trim();
